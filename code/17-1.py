...
parser.add_argument('-i', '--SBinputfile' , metavar='', default = default_inputfile, help='le nom du fichier d\'entré de swissborg (doit etre dans le meme repertoire que le programme). par default :'+ default_inputfile)
...
writer = pd.ExcelWriter(reportfile, engine='xlsxwriter',datetime_format='d mmm yyyy  hh:mm')
